...
/**
 * @brief Removes the last node in the list and return the node
 * @param list The list you want to remove the node from.
 * @return Returns the node contained in the list or NULL if list is empty.
*/
